...
|----|-------|-------------|----------------|-----------|
| T1.1 | Crear Nombre del Producto | Sharon y Joan | 5m | Alta |
| T1.2 | Crear Logo | Sharon y Joan | 20m | Alta |
| T1.3 | Definir version Android | Sharon | 5m | Alta |
| T1.4 | Configurar version Kotlin | Sharon | 5m | Alta |
...
| T3.1.1 | Layout Home | Sharon y Joan | 4h | Alta |
| T3.1.3 | Layout Viajes | Sharon y Joan | 2h | Alta |
| T3.1.4 | Layout Login | Sharon y Joan | 1h | Alta |
| T3.1.5 | Layout Registrarse | Sharon y Joan | 1h | Alta |
| T3.1.6 | Layout Perfil | Sharon y Joan | 1h | Alta |
| T3.1.7 | Layout Recomendaciones | Sharon y Joan | 2h | Alta |
| T3.1.8 | Layout Mapa | Sharon y Joan | 2h | Alta |
| T3.1.9 | Layout Página About | Sharon y Joan | 1h | Alta |
...
- [ ] Que la aplicacion tenga todas las pantallas propuestas hechas con una navegacion correcta
- [ ] Cumplir con todas las tareas de prioridad alta y gran parte o todas las de prioridad media
...
- Mucha carga de trabajo en 2 semanas
- Poca experiencia en Kotlin
