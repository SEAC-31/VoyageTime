...
private val VoyageLightColorScheme = lightColorScheme(
    ...
    onBackground = BackgroundBlack,        // negro sobre blanco
    surface = Color(0xFFF7F7F7),
    onSurface = Color(0xFF111111),         // negro sobre cards
    surfaceVariant = Color(0xFFEAF6FC),
    onSurfaceVariant = Color(0xFF4B5563),  // gris visible
    outline = VoyageOrange.copy(alpha = 0.35f)
)

@Composable
fun VoyageTimeTheme(
    darkTheme: Boolean = false,  // false = claro por defecto
